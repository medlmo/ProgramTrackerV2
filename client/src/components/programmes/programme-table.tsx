...
export default function ProgrammeTable({ programmes, isLoading, onEdit }: ProgrammeTableProps) {
  ...
  const getSecteurColor = (secteur: string) => {
    const colors: Record<string, string> = {
      Agriculture: "bg-green-100 text-green-800 dark:bg-green-900/20 dark:text-green-400",
      ...
      Artisanat: "bg-orange-100 text-orange-800 dark:bg-orange-900/20 dark:text-orange-400",
      Services: "bg-gray-100 text-gray-800 dark:bg-gray-900/20 dark:text-gray-400",
